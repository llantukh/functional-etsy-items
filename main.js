...
var findItemsByPrice = function (item) {
  var itemsByPrice = [];
  for (var count = 0; count < item.length; count++){
    var temp = item[count].price;
    if (temp > 14 && temp < 18) {
      itemsByPrice.push(item[count].title);
    };
  };
  return itemsByPrice;
};
var answer2 = document.getElementById ("answer2");
answer2.innerHTML = findItemsByPrice(items);

//Question 3: Which item has a "GBP" currency code? Display it's name and price.



// var findGBP = function () {
//   var itemsByGBP = [];
//   for (var count = 0; count < items.length; count++){
//     var currency = items[count].currency_code;
//     if (currency === "GBP" {
//       itemsByGBP.push(item[count].title);
//     }
//   }
//   return itemsByGBP;
// };
